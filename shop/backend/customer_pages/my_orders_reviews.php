...
<main class="bg-background">
    <div class="order-box bg-[#eeeeee] shadow-md rounded-xl p-6 mb-6 border border-gray-200">
        ...
        <?php if (!$alreadyReviewed): ?>
            <form method="POST" action="/student002/shop/backend/db/db_reviews.php" class="review-form mt-4 space-y-4 text-texto">
                ...
                <div>
                    ...
                    <select name="rating" required class="w-full border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <textarea name="comment" rows="3" required class="w-full border border-gray-300 rounded-lg p-3 resize-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Escribe tu opinión sobre el producto..."></textarea>
                </div>
