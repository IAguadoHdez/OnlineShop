...
<body class="bg-[#0D0D0D] m-0 p-0 font-sans">
	<div class="fixed inset-0 z-50 flex items-center justify-center">
		<div class="bg-[#1A1A1A] shadow-2xl rounded-2xl p-10 w-96 text-center border border-[#737373]/30">
			<h1 class="text-2xl font-semibold mb-6 text-texto">Eliminar cliente</h1>
			<form action="form_customer_delete.php" method="POST" class="flex flex-col space-y-4">
				...
				<input type="submit" value="Eliminar" class="bg-[#FF4D00] text-texto py-2 rounded-xl cursor-pointer font-semibold hover:bg-[#00C4CC] hover:text-[#0D0D0D] transition-all duration-200">
			</form>
