...
<div class="fixed inset-0 flex items-center justify-center z-50">
    <div class="bg-[#1A1A1A] p-10 rounded-2xl shadow-2xl text-center max-w-md w-full border border-[#737373]/30">
        ...
        <?php if ($customerInsertado === true) { ?>
            <h1 class="text-2xl font-bold mb-6 text-texto">Cliente insertado</h1>
        ...
        <?php if ($customerInsertado === false) { ?>
            <h1 class="text-2xl font-bold mb-6 text-texto">Error al insertar</h1>
            <p class="mb-8 text-texto">
        ...
        <?php if ($customerInsertado === null) { ?>
            <h1 class="text-2xl font-bold mb-6 text-texto">Insertar Cliente</h1>
            <form method="POST" class="flex flex-col items-center space-y-4">
                ...
                <input type="submit" value="Insertar" class="w-64 bg-[#FF4D00] text-texto py-2 rounded-xl font-bold cursor-pointer hover:bg-[#00C4CC] hover:text-[#0D0D0D] transition-all duration-200">
            </form>
        <?php } ?>
