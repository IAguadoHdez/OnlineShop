...
<body class="bg-background text-texto min-h-screen font-sans">
  <nav
    ...
    <div class="flex items-center">
      ...
      <span class="text-texto font-semibold flex items-center gap-2 text-xl">
    ...
    <div class="flex flex-wrap gap-5 items-center justify-center text-xl">
      ...
      <?php if (!$_SESSION) {
        ...
        echo "<div> <a href='/student002/shop/backend/shopping_cart.php'><button type='submit'class='icono fa-solid fa-cart-shopping fa-xl cursor-pointer hover:text-accent'></button></a></div>";
      }
      ?>
    </div>
  </nav>